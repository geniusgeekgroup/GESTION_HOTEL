    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clients', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Payer',
                                              to='GesHotel.Client')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chambres', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Couter',
                                               to='GesHotel.Chambre')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chambre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='COnso_1',
                                              to='GesHotel.Chambre')),
                ('clients', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='COnso_2',
                                              to='GesHotel.Client')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chambres',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_chambre',
                                   to='GesHotel.Chambre')),
                ('maitrehotels',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Gerer_chambre',
                                   to='GesHotel.MaitreHotel')),
                ('receptionnists',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_chambre',
                                   to='GesHotel.Receptionnist')),
            ],
        ),
        migrations.CreateModel(
            name='ReserverSalle',
            fields=[
                ...
                ('statut_reservation', models.BooleanField(default=False, verbose_name='Statut Reservation')),
                ('clients',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_salle',
                                   to='GesHotel.Client')),
                ('receptionnists',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_salle',
                                   to='GesHotel.Receptionnist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_reservation', models.BooleanField(default=False, verbose_name='Statut Reservation')),
                ('receptionnists',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_table',
                                   to='GesHotel.Receptionnist')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_table', models.BooleanField(default=False, verbose_name='Statut Table')),
                ('etatsalles', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Etre_dans',
                                                 to='GesHotel.EtatSalle')),
            ],
        ),
        migrations.CreateModel(
            name='Table',
            fields=[
                ...
                ('etattable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Etre_dans',
                                                to='GesHotel.EtatTable')),
                ('maitrehotel',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Gerer_Table',
                                   to='GesHotel.MaitreHotel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='salle',
            name='typesalles',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Constituer',
                                    to='GesHotel.TypeSalle'),
        ),
        migrations.AddField(
            model_name='reservertable',
            name='salles',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_table',
                                    to='GesHotel.Salle'),
        ),
        migrations.AddField(
            model_name='reservertable',
        ...
        migrations.AddField(
            ...
            name='salles',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_salle',
                                    to='GesHotel.Salle'),
        ),
        migrations.AddField(
            model_name='reserverchambre',
            name='salles',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reserver_chambre',
                                    to='GesHotel.Salle'),
        ),
        migrations.AddField(
            model_name='client',
            name='typepiececlient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Appartenir',
                                    to='GesHotel.TypePieceClient'),
        ),
        migrations.AddField(
            model_name='chambre',
            name='chefreception',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Gerer',
                                    to='GesHotel.ChefReception'),
        ),
        migrations.AddField(
            model_name='chambre',
            name='etatchambre',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Voir',
                                    to='GesHotel.EtatChambre'),
        ),
        migrations.AddField(
            model_name='chambre',
            name='hotel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Gerer',
                                    to='GesHotel.Hotel'),
        ),
        migrations.AddField(
            model_name='chambre',
            name='typechambre',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Avoir',
                                    to='GesHotel.TypeChambre'),
        ),
    ]
